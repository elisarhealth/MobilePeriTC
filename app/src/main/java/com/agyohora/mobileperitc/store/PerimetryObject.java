...
/**
 * Created by Invent on 17-2-18.
 */

public class PerimetryObject {
    ...
    public static class TestParameterInfo {
        static double VisualFieldHorizontalExtent;
        static double VisualFieldVerticalExtent;
        static String VisualFieldShape;
        static CodeSequence ScreeningTestModeCodeSequence;
        static double MaximumStimulusLuminance;
        static double BackgroundLuminance;
        static CodeSequence StimulusColorCodeSequence;
        public static CodeSequence BackgroundIlluminationColorCodeSequence;//make dynamic
        static double StimulusArea;
        static double StimulusPresentationTime;
    ...
    public static class TestResultsInfo {
        ...
        TestResultsInfo() {
            ...
            VisualFieldGlobalResultsIndexSequence = new VisualFieldGlobalResultsIndexSequence();
        }

    }//class for test results

    public static class VisualFieldGlobalResultsIndexSequence {
        public static DataObservationSequence DataObservationSequence;
