...
public class DoctorsCopyFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.doctor_copy_layout, container, false);
    }
    ...
    public void onViewCreated(@NonNull final View view, @Nullable Bundle savedInstanceState) {
       ...
       /* String pattern_and_strategy = "Central " + pattern + " " + strategy + " Test";
        ...
        String ghtD = bundle.getString("GHT");
        ghtD = "GHT\n" + ghtD;
        ...
        spanbablemD.setSpan(new android.text.style.StyleSpan(android.graphics.Typeface.BOLD), 0, 2, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);

        ((TextView) view.findViewById(R.id.ghtText)).setText(spanbableGHT);
        ((TextView) view.findViewById(R.id.mdText)).setText(spanbablemD);
        ((TextView) view.findViewById(R.id.gpsdText)).setText(spanbablePsd);

        String vfiData = bundle.getString("VFI");
        vfiData = "VFI\n" + vfiData + " %";
        SpannableStringBuilder spanbableVFI = new SpannableStringBuilder(vfiData);
        spanbableVFI.setSpan(new android.text.style.StyleSpan(android.graphics.Typeface.BOLD), 0, 3, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
        ((TextView) view.findViewById(R.id.vfiText)).setText(spanbableVFI);
        ...
        taskTwo = new LoadMappedLargeText(getActivity(), imageTwo).execute(values, result, result_deviation);
        taskThree = new LoadMappedLargeText(getActivity(), imageThree).execute(values, result, result_generalizedDefectCorrectedSensitivityDeviationValue);
        ...
        taskSix = new LoadGreyScale(getActivity(), imageGreyScale, eye, progressBar, DoctorsCopyFragment.this).execute(quadrants);
    }
    ...
    public void onPrepareOptionsMenu(Menu menu) {
        ...
        if (loadingFlag) {
           ...
           menu.findItem(R.id.action_doctor_bluetooth_report).setVisible(false);
            ...
            menu.findItem(R.id.action_doctor_bluetooth_report).setVisible(true);
    ...
    private void triggerUserAction(String action) {
        ...
        if (action.equals("print")) {
           ...
           // sendFileOverBluetooth();
            new DoctorReportPdf(bundle, getActivity(), getContext(), "bluetooth").execute();
        }
    }
    ...
    private static class LoadGreyScale extends AsyncTask<double[][][], Void, Bitmap> {
        ...
        String eye;
        WeakReference<DoctorsCopyFragment> weakReference;
        private ImageView imageView;

        LoadGreyScale(Activity activity, ImageView imageView, String eye, ProgressBar progressBar, DoctorsCopyFragment doctorsCopyFragment) {
            this.activity = activity;
            this.imageView = imageView;
            this.eye = eye;
            this.progressBar = progressBar;
            this.weakReference = new WeakReference<>(doctorsCopyFragment);
        }
    ...
    private class DoctorReportPdf extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... voids) {
            ...
            String pattern = bundle.getString("setPatientTestPatternVal");
            doctorLayout = mInflater.inflate(R.layout.doctor_report_pdf, view1, true);
            //doctorLayout = view1;
            ...
            SpannableStringBuilder spanbableGHT = new SpannableStringBuilder(ghtD);
            spanbableGHT.setSpan(new android.text.style.StyleSpan(android.graphics.Typeface.BOLD), 0, 3, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
            ((TextView) doctorLayout.findViewById(R.id.ghtData)).setText(spanbableGHT);

            String vfiData = bundle.getString("VFI");
            vfiData = "VFI: " + vfiData + " %";
            SpannableStringBuilder spanbableVFI = new SpannableStringBuilder(vfiData);
            spanbableVFI.setSpan(new android.text.style.StyleSpan(android.graphics.Typeface.BOLD), 0, 3, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
            ((TextView) doctorLayout.findViewById(R.id.vfiData)).setText(spanbableVFI);
