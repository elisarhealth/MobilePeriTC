...
public class ResetAdminPassword extends AppCompatActivity {
    ...
    TextInputLayout  enter_new_admin_password_layout, re_enter_new_admin_password_layout;
    EditText  enter_new_admin_password, re_enter_new_admin_password;
                ...
                new EditText.OnEditorActionListener() {
                    ...
                    public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
                        ...
                        if (actionId == EditorInfo.IME_ACTION_SEARCH
                            ...
                            resetAdminPasswordSettings(submit_admin_password_button);
                            return true;
                        }
    ...
    public void resetAdminPasswordSettings(View v) {
    ...
    TextWatcher enter_new_passwordWatcher = new TextWatcher() {
        ...
        public void afterTextChanged(Editable s) {
            if (isItOldPassword()) {
                ...
                enter_new_admin_password_layout.setError("Password must contain at least one character of 0-9 a-z A-Z [@#$%^&+=]");
                re_enter_new_admin_password.setEnabled(false);
