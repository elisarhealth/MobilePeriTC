...
public class CustomLinearLayout extends LinearLayout {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int holeRadius = 40;
        mPath.quadTo(40, h / 2, w - holeRadius, h / 2);


        cv.drawCircle(0, h / 2, holeRadius, eraser); // middle_left
        cv.drawCircle(w, h / 2, holeRadius, eraser); // middle_right
        // drawing the image
