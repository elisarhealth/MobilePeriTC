 ...
 * AsyncTask to create doctor's copy graphs four and five
 */

public class LoadMappedIconView extends AsyncTask<ArrayList<String>, Void, Bitmap> {
    private Activity activity;
    private ImageView imageView;

    public LoadMappedIconView(Activity activity, ImageView imageView) {
    ...
    protected final Bitmap doInBackground(ArrayList<String>... params) {
        ...
        View graphFive = CommonUtils.getMappedIconView(activity, pattern, eye, result, result_values);
        return CommonUtils.viewToBitmap(graphFive);
    }
