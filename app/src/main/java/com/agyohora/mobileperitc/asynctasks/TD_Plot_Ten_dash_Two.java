...
public class TD_Plot_Ten_dash_Two extends AsyncTask<ArrayList<String>, Void, Bitmap> {
    private Activity activity;
    private ImageView imageView;

    public TD_Plot_Ten_dash_Two(Activity activity, ImageView imageView) {
    ...
    protected final Bitmap doInBackground(ArrayList<String>... params) {
        ...
        View graphTwo = CommonUtils.getTD_Plot(activity, eye, result, result_values,result_deviation);
