 ...
 * AsyncTask to create doctor's copy graph one
 */

public class LoadMappedView extends AsyncTask<ArrayList<String>, Void, Bitmap> {
    private Activity activity;
    private ImageView imageView;

    public LoadMappedView(Activity activity, ImageView imageView) {
    ...
    protected final Bitmap doInBackground(ArrayList<String>... params) {
        ...
        View graphTwo = CommonUtils.getMappedView(activity, pattern, eye, result, result_values);
